  ...
  return (
    <>
      <footer className="w-full min-h-[250px] bg-[#7525a7] flex flex-col items-center">
        ...
        <div className="w-full lg:W-[1024px] text-center text-white font-bold py-[30px] px-0 border-t-[1px] border-[#ba53fb]">
          © 2014 - 2024 - Tiendamia - Todos los derechos reservados
        </div>
      </footer>
    </>
  );
